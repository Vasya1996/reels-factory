...
#
# ОСТОРОЖНО: одного имени семейства мало. Без нашего @font-face из
# hf_fonts.fonts_css() движок подтянет Manrope из Google Fonts — там
# кириллица есть, поэтому русский отрисуется безупречно, но казахских
# ә ғ қ ң ұ и всех заглавных казахских у неё нет. Поломка тихая и вылезет
# только на казахском тексте.
...
Стиль `{STYLE_NAME}` из библиотеки стилей скила, один на весь ролик. Русский
и казахский текст веди гарнитурами {FONTS} — но именно нашими файлами
(`reels_factory.hf_fonts`, `hyperframes/_fonts/`). Одного имени семейства
мало: без нашего `@font-face` движок подтянет Manrope из Google Fonts, где
кириллица есть — русский выйдет безупречным, — но нет казахских ә ғ қ ң ұ и
ни одной заглавной казахской. Отказ тихий, вылезет только на казахском.
Подключение этих файлов в готовую композицию на этом пути ещё не
автоматизировано — сам определи, как встроить их (например, `@font-face` с
data-URI), и проверь глазами, что кириллица и казахские буквы реально
отрисовались тем же шрифтом, что и латиница, а не превратились в пустые
прямоугольники или другой шрифт. Ссылок на внешние шрифты не пиши.
