...
(«фото из каталога»), ни пояснений о самом ролике. Всё, что зритель читает, —
это титр, а он строится из самой озвучки.
