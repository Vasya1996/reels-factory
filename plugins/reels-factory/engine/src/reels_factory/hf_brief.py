...
схемы, остаётся полный кадр (свод правил, «Где ведущая»).""")
    ...
    catalog_step = ("Пройди сцены ещё раз, теперь по каталогу: каждой скажи "
                    "одной фразой,\n   что она должна сделать со зрителем, и "
                    "поищи этой фразе позицию —\n   как ищут, сказано в своде "
                    "правил, раздел «Чем занять кадр: позиция\n   каталога». "
...
6. Оба файла на месте: `storyboard.json` и `frame.md`.
