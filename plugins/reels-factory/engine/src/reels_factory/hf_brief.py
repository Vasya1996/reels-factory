...
# кириллицу и (с донорским патчем в hf_fonts.py) казахские буквы; это НЕ то
# же самое, что одноимённые Manrope/Unbounded из каталога скила — у тех
# кириллицы нет. Montserrat/Inter (прежнее значение) тоже не подходили:
# у Inter нет ни казахских букв, ни двенадцати заглавных русских; у
# Montserrat строчные казахские есть, заглавных нет — проверено fontTools.
...
и казахский текст веди гарнитурами {FONTS} — это наши собственные файлы
(`reels_factory.hf_fonts`, `hyperframes/_fonts/`), а НЕ одноимённые шрифты
из каталога скила: у каталожных Manrope и Unbounded кириллицы нет вовсе.
