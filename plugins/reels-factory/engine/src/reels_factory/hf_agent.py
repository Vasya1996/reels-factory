...
Материал уже готов в public/. Своё распознавание речи не запускай, бироллы
сам не ищи, композицию не собирай — это делает код по твоему плану.

Верни два файла: `storyboard.json` и `frame.md` — оба в формате из задания.
Разметку не пиши вовсе: ни HTML, ни CSS, ни JavaScript. Ничего не
