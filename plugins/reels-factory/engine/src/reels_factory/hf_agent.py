...
его целиком и следуй ему буквально: числа в нём не рекомендации, а границы.
Материал уже готов в public/, что делает код после тебя — сказано в задании."""
...
SYSTEM_PROMPT = """Ты работаешь автономно: человек не смотрит за прогоном и не
может ответить на вопрос по ходу дела. Все решения принимай сам и доводи работу
до конца — заканчивай ход готовыми файлами, а не вопросом или обещанием.
