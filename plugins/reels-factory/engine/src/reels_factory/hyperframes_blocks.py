...
# дублируют литералом; test_hf_env.py следит за этим). Пин поднят с 0.8.27
# до 0.8.33 09.09.2026 — их скиллы всё равно тянутся с main без версии, дрейф
# гасит только сам пин. docs/research/hyperframes/findings.md снято под
# 0.7.84 и не переписывалось ни на 0.8.27, ни на этот подъём — досье под
# текущий пин в репозитории по-прежнему нет.
_HF_VERSION = "0.8.33"
