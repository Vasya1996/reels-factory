...
def build_prompt(hypothesis: dict) -> str:
    ...
    parts = [
        ...
        "Слова пиши в обычном написании, без знака ударения над гласной: "
        "озвучка читает его ненадёжно, а в титрах он виден как лишний значок. "
        "Не добавляй в speech метакоманды и аудиотеги "
