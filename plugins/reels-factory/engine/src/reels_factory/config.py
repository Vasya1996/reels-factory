...
BILLING_DEFAULTS = {
    ...
    "rates": {
        ...
        #
        # Решение Васи 03.09.2026: в цену закладывается $1 на ролик, разница
        # между этим и фактом — наша маржа, а не доплата клиента (названная
        # цена окончательна, см. billing.py JobMeter).
        "claude_montage_usd_per_reel": 0.50,
