...
BILLING_DEFAULTS = {
    ...
    "rates": {
        ...
        #
        # claude_montage_usd_per_reel поднят с $1.60 до $2.20: при attempts=2
        # даёт провизию $4.40 — над p75 ($4.39) с минимальным запасом, там же
        # была и медиана одной сессии раньше ($1.60 — теперь давала только
        # $3.20, ниже p75).
        "claude_montage_usd_per_reel": 2.20,
