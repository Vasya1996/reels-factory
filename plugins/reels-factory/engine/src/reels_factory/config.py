...
BILLING_DEFAULTS = {
    ...
    "rates": {
        ...
        #
        # Решение Васи 03.09.2026: в цену закладывается $2 на ролик. Здесь
        # стоит ставка ОДНОГО прохода — $2 получается умножением на
        # claude_montage_attempts (объявлен ниже). Правишь это число — считай
        # вместе с множителем, иначе провизия удвоится молча. Разница с фактом
        # (медиана $2,85, p75 $4,39) — наша маржа, названная цена окончательна
        # (см. billing.py JobMeter).
