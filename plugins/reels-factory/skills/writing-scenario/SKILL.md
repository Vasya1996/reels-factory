...
3. Напиши сценарий по таймингу в процентах от `length_s`:
   ...
   Хук уложи в ОДНО короткое предложение, CTA — в ДВА, считая дословную
   фразу призыва. От `length_s` эти потолки не растут: обе роли ролик говорит
   лицом, и каждая их секунда — оплаченная секунда ведущей, которой не
   достанется вставкам. Хук такой длины: «Ты платишь за то, что собирается за
   десять минут».
...
- Хук — одно предложение; CTA — два вместе с дословной фразой призыва.
