...
3. Напиши сценарий по таймингу в процентах от `length_s`:
   ...
   фразу призыва. От `length_s` эти потолки не растут: короткий хук
   останавливает пролистывание, длинный — теряет зрителя раньше сути. Хук
   такой длины: «Ты платишь за то, что собирается за десять минут».
