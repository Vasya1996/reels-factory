...
1. Прочитай файл задания (путь в аргументе):
   ...
   секундах, цитаты-опоры, `gender` — пол рассказчика), учитывай его при
   формулировках; о себе рассказчик говорит в роде `task.gender`: «я
   сделал» при `male`, «я сделала» при `female` — и так же в прилагательных
   о себе. Поля нет — род не меняй; `"issues"` —
