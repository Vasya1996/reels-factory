# Визуальный критик — круг 2 (C:\Users\Asus\Documents\personal_ai\projects\content_factory\reels-factory-hyperframes-workflow-poc\experiments\hyperframes-workflow-poc\golden-catalog\project-boutique-hotel)
...
- Кадры: start@0.4s → snapshots-round2/frame-00-at-0.4s.png; mid@2.48s → snapshots-round2/frame-01-at-2.48s.png
...
- headline: "ДОЛГО ЖДУТ"
- labels: [{"text":"вкладывают","trigger_word_index":10},{"text":"десятилетиями","trigger_word_index":16},{"text":"прибыль","trigger_word_index":15}]
- emphasis_words: ["десятилетиями"]
- Кадры: start@5.37s → snapshots-round2/frame-02-at-5.37s.png; mid@6.93s → snapshots-round2/frame-03-at-6.93s.png
...
- Кадры: start@9.28s → snapshots-round2/frame-04-at-9.28s.png; mid@10.05s → snapshots-round2/frame-05-at-10.05s.png

### s04 (purpose: explain, block: taskList, avatar_direction: object_overlay, captions: bottom, transition_in: hard_cut)
...
- Кадры: start@11.63s → snapshots-round2/frame-06-at-11.63s.png; mid@13.69s → snapshots-round2/frame-07-at-13.69s.png
...
- headline: null
- labels: [{"text":"почти вдвое","trigger_word_index":36},{"text":"пятнадцать лет","trigger_word_index":43},{"text":"рентабельность","trigger_word_index":45}]
- emphasis_words: ["пятнадцать"]
- Кадры: start@16.55s → snapshots-round2/frame-08-at-16.55s.png; mid@19.57s → snapshots-round2/frame-09-at-19.57s.png
...
- Кадры: start@23.4s → snapshots-round2/frame-10-at-23.4s.png; mid@25.01s → snapshots-round2/frame-11-at-25.01s.png
...
- headline: null
- labels: [{"text":"разница","trigger_word_index":57}]
- emphasis_words: ["рубль"]
- Кадры: start@27.42s → snapshots-round2/frame-12-at-27.42s.png; mid@28.5s → snapshots-round2/frame-13-at-28.5s.png
...
- Кадры: start@30.38s → snapshots-round2/frame-14-at-30.38s.png; mid@31.52s → snapshots-round2/frame-15-at-31.52s.png

## Кадры

Открой файлы snapshots-round2/*.png (перечислены выше при каждой сцене)
